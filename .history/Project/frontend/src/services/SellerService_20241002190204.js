...
export class SellerService {
  ...
  // Get the todo items for a seller
  async getTodo(sellerId) {
    return await axios.get(`http://localhost:8000/sellers/${sellerId}/todo/`);
  }

  // Update the todo items for a seller
  async updateTodo(sellerId, todoUpdate) {
    return await axios.patch(`http://localhost:8000/sellers/${sellerId}/todo/update/`, { todo: todoUpdate });
  }
