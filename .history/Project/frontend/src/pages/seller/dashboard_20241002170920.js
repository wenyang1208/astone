...
const Dashboard = () => {
    ...
    useEffect(() => {
        const fetchTodoData = async () => {
            try {
                const sellerId = 1; // Replace with dynamic seller ID if needed
                const response = await axios.get(`/api/seller/${sellerId}/todo/`);
    ...
    const firstRowItems = [
        ...
        { value: todoData.toProcessShipment, label: "To-Process Shipment" },
