...
import { Container, Typography, Button, Divider, Paper, Grid, IconButton, CircularProgress, Box, TextField, List, ListItem, ListItemText, Dialog, DialogTitle, DialogContent, DialogActions, Checkbox, FormControlLabel } from '@mui/material';
  ...
  return (
    <Container maxWidth="md">
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={4}>
            <Paper elevation={3} sx={{ p: 3 }}>
              ...
              <Box sx={{ mt: 3, mb: 2 }}>
                <Typography variant="h6" gutterBottom>
                  Total: MYR {(totalPrice - discount).toFixed(2)}
                </Typography>
              </Box>
              <Button 
                variant="contained" 
      ...
      <Dialog open={paymentOpen} onClose={handleClosePayment}>
        ...
        <DialogContent>
          <Typography variant="body1" gutterBottom>Total Price: MYR {totalPrice - discount}</Typography>
