...
urlpatterns = [
    ...
    path('order/<int:order_item_id>/edit', update_order_seller, name='update_order'),
    ...
    path('seller/<int:seller_id>/increment-shipment/', increment_processed_shipment, name='increase_processed_shipment'),
        path('seller/<int:seller_id>/increment-processed-shipment/', increment_processed_shipment, name='increase_processed_shipment'),
