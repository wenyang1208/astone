...
class Seller(models.Model):
    ...
    phone_number = models.PositiveBigIntegerField(null=False, default='', help_text="gender of the seller")
    address = models.TextField(null=False, default='', help_text="gender of the seller")
    password = models.CharField(max_length = 30, null=False, default='', help_text="gender of the seller")
