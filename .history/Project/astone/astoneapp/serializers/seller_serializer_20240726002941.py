...
class SellerSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        seller_profile, created = Seller.objects.update_or_create(user=user, gender=validated_data.pop('gender'),address=validated_data.pop('address') ,address=validated_data.pop('address'))
