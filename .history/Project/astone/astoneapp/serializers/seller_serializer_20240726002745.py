...
class SellerSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        seller_profile, created = SellerProfile.objects.update_or_create(user=user, business_name=validated_data.pop('business_name'), address=validated_data.pop('address'))
