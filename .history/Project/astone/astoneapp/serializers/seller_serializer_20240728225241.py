...
class SellerSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        seller, created = Seller.objects.create(user=user, gender=validated_data.pop('gender'), phone_number=validated_data.pop('phone_number'), address=validated_data.pop('address'))
        return seller
