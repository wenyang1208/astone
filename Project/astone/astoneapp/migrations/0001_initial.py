# Generated by Django 5.0.4 on 2024-10-16 18:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='astoneapp.product')),
                ('seller', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='astoneapp.seller')),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
                ...
                ('custom_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='astoneapp.customuser')),
                ('seller', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='astoneapp.seller')),
            ],
        ),
        migrations.CreateModel(
